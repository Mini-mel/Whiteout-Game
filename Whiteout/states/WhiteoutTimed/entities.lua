...
function ents.Startup()
	regi["circle"] = love.filesystem.load( "states/WhiteoutTimed/entities/circle.lua")
	regi["square"] = love.filesystem.load( "states/WhiteoutTimed/entities/square.lua")
	regi["triangle"] = love.filesystem.load( "states/WhiteoutTimed/entities/triangle.lua")
	regi["star"] = love.filesystem.load( "states/WhiteoutTimed/entities/star.lua")
end

--derives info from base entity into specific entity
function ents.Derive(name)
	return love.filesystem.load( "states/WhiteoutTimed/entities/" .. name .. ".lua")()
end
